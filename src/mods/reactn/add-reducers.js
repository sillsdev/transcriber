...
function _addReducers(globalStateManager, reducers) {
  ...
  try {
    for (
      ...
      var _d = __read(_c.value, 2),
        ...
        reducer = _d[1];
      removeReducers.add(
        add_reducer_1.default(globalStateManager, name_1, reducer)
      );
    }
  } catch (e_1_1) {
    e_1 = { error: e_1_1 };
  ...
  return function () {
    ...
    try {
      for (
        var removeReducers_1 = __values(removeReducers),
          removeReducers_1_1 = removeReducers_1.next();
        !removeReducers_1_1.done;
        removeReducers_1_1 = removeReducers_1.next()
      ) {
      ...
      try {
        if (
          removeReducers_1_1 &&
          !removeReducers_1_1.done &&
          (_a = removeReducers_1.return)
        )
          _a.call(removeReducers_1);
      } finally {
