...
var _a = __read(
    react_1.version.split('.').map(function (v) {
      return parseInt(v);
    }),
    2
  ),
...
function ReactN(DecoratedComponent) {
  var DecoratedReactNComponent = (function (_super) {
    ...
    DecoratedReactNComponent.prototype.UNSAFE_componentWillUpdate =
      function () {
        var args = [];
        for (var _i = 0; _i < arguments.length; _i++) {
          args[_i] = arguments[_i];
        ...
        if (_super.prototype.UNSAFE_componentWillUpdate) {
          _super.prototype.UNSAFE_componentWillUpdate.apply(
            this,
            __spread(args)
          );
        }
    ...
    DecoratedReactNComponent.prototype.setGlobal = function (
      newGlobalState,
      callback
    ) {
      if (callback === void 0) {
    ...
    DecoratedReactNComponent.displayName =
