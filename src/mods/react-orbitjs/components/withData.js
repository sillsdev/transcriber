...
function withData(mapRecordsToProps, mergeProps) {
  ...
  return function wrapWithConnect(WrappedComponent) {
    var componentDisplayName =
      'WithData(' + getDisplayName(WrappedComponent) + ')';
    ...
    var WithData = (function (_Component) {
      ...
      function WithData(props, context) {
        ...
        var _this = _possibleConstructorReturn(
          this,
          (WithData.__proto__ || Object.getPrototypeOf(WithData)).call(
            this,
            props,
            context
          )
        ...
        if (!_this.dataStore) {
          throw new Error(
            'Could not find "dataStore" in either the context or ' +
              ...
              ('or explicitly pass "dataStore" as a prop to "' +
    ...
    var _initialiseProps = function _initialiseProps() {
      ...
      this.computeChangedRecordProps = function (
        ...
        return _this2.selectivelyComputeRecordProps(
          selectedRecordProps,
          dataStore,
          props
        );
      ...
      this.selectivelyComputeRecordProps = function (
        ...
        var recordProps = selectedRecordPropsOrAll.reduce(
          _this2.makeReducePropsToRecords(dataStore, recordQueries),
          {}
        );
        ...
        recordQueryKeys.forEach(function (prop) {
          ...
          switch (expression.op) {
            ...
            case 'findRelatedRecords':
              _this2.subscribedModels[prop].push(expression.record.type);
              _this2.subscribedModels[prop].push(
                _this2.dataStore.schema.models[expression.record.type]
        ...
        recordQueryKeys.forEach(function (prop) {
          if (
            ...
            JSON.stringify(currentExpressions[prop]) !==
              JSON.stringify(_this2.lastExpressions[prop])
          ) {
            _this2.expressionChangedProps.push(prop);
          }
        });

        _this2.lastExpressions = currentExpressions;
      ...
      this.updateRecordPropsIfNeeded = function () {
        ...
        if (_this2.recordProps === null) {
          nextRecordProps = _extends(
            {},
            _this2.getConvenienceProps(_this2.dataStore),
            _this2.computeAllRecordProps(_this2.dataStore, _this2.props)
          );
        } else if (
          _this2.haveOwnPropsChanged &&
          _this2.doRecordPropsDependOnOwnProps
        ) {
          nextRecordProps = _extends(
            {},
            _this2.recordProps,
            _this2.computeChangedQueryProps(_this2.dataStore, _this2.props)
          );

          // Remove all props no longer returned from mapRecordsToProps
          var recordQueryKeys = Object.keys(_this2.subscribedModels);
          var conveniencePropKeys = Object.keys(
            _this2.getConvenienceProps(_this2.dataStore)
          );
          ...
          nextRecordProps = _extends(
            {},
            _this2.recordProps,
            _this2.computeChangedRecordProps(
        ...
        if (
          _this2.recordProps &&
          (0, _shallowEqual2.default)(nextRecordProps, _this2.recordProps)
        ) {
          return false;
        }
      ...
      this.updateMergedPropsIfNeeded = function () {
        ...
        if (
          _this2.mergedProps &&
          (0, _shallowEqual2.default)(nextMergedProps, _this2.mergedProps)
        ) {
          return false;
        }
