...
const initialState = {
  ...
  newProject: new LocalizedStrings({
    en: {
      ...
      blankFactor1:
        'Best option if multiple pre-recorded audio files are available',
      ...
      generalTip:
        'General transcription can cover a wide range of working scenarios and product solutions.',
      keyFactors: 'Key Factors',
      likeTemplate:
        'These options present different templates for getting started. Choices made here can be changed in the Edit Audio Project Settings dialog.',
      newProject: 'New Audio Project',
      other: 'Other',
      ...
      scriptureTip:
        'The final product may be audio or text and the content type may be translation, stories, drafting or adapation.',
  ...
  transcriptionTab: new LocalizedStrings({
    en: {
      ...
      noData: 'No {0} Data.',
      offlineData:
        'You cannot export an online project after creating new content offline (recordings, discussions, comments etc.). Please export an ITF file.',
      changed: 'Changed',
      passages: 'Passages',
      plan: 'Plan',
