...
const initialState = {
  ...
  vProject: new LocalizedStrings({
    en: {
      ...
      errExtrasBookLen: 'Book must be 3 characters',
      errExtrasBookNonScripture:
        'Book Designation must not be a Scripture book code.',
      extrasBook: 'Akuo Extras Book Designation',
      flat: 'Flat',
      font: 'Font',
      fontSize: 'Font Size',
