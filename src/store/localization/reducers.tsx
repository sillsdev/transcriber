...
const initialState = {
	...
	"planSheet": new LocalizedStrings({
		"en": {
			...
			"confirmPublishSectionNoPropagate": "If you choose to publish, the {0} will be marked as published but the publishing status of the passages and notes in this {0} will not be changed. If you have previously published and now choose 'Not Published', the {0} will be marked as not published.",
