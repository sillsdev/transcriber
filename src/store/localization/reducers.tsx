...
const initialState = {
  ...
  cards: new LocalizedStrings({
    en: {
      ...
      explainTeamDelete:
        'Deleting the team will delete all projects of the team.',
  ...
  electronImport: new LocalizedStrings({
    en: {
      ...
      members: 'Members',
      userWontSeeProject:
        'You are not a member of this project team. This project will not be accessible after import.',
      importProject: 'Import Project',
      invalidProject: 'Import File does not contain current project.',
      lastExported:
        'Current data in project {name0} was last exported {date0}.',
      neverExported:
        'Current data in project {name0} has never been exported to an itf file to preserve changes.',
      projectImported:
        'Project {name0} was previously imported with a newer file: {date1} ',
  ...
  groupSettings: new LocalizedStrings({
    en: {
      ...
      addMemberInstruction:
        'Choose a person who will act as a {0} for projects in this group.',
  ...
  import: new LocalizedStrings({
    en: {
      ...
      old: 'Previous Value',
      onlineChangeReport:
        'Online changes made since data provided to offline member:',
      other: 'Other',
      passage: 'Passage',
      phone: 'Phone',
      plan: 'Project',
      ...
      projectNotFound:
        'ITF does not contain current project.  It contains project {0}.',
      showHideFilter: 'Show/Hide filter rows',
      state: 'State',
      timezone: 'Time zone',
  ...
  planSheet: new LocalizedStrings({
    en: {
      ...
      pasting: 'Pasting',
      refErr:
        'This project contains invalid references and will not sync to Paratext properly. (A valid reference would be 3:2-5 or similar.)',
  ...
  transcriptionTab: new LocalizedStrings({
    en: {
      ...
      export: 'Export',
      exportExplanation:
        'Export the full project to store locally or share with another offline member. Export incremental file to import changes into online app.',
      ...
      exportTooLarge:
        'The project cannot be exported.  The export file is too large.',
...
const LocalizationReducers = function (
  state = initialState,
  action: any
): ILocalizedStrings {
  switch (action.type) {
