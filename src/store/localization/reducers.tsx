...
const initialState = {
	...
	"workflowSteps": new LocalizedStrings({
		"en": {
			"backTranslation": "Back Translation",
			"backTranslation-D": "Back Translation",
			"backTranslation-S": "Back Translation",
			"communityTesting": "Community Testing",
			"communityTesting-D": "Community Testing",
			"communityTesting-S": "Community Testing",
			"consultantCheck": "Consultant Check",
			"consultantCheck-S": "Consultant Check",
			...
			"internalization-S": "Internalization",
			"keyTerms": "Key Terms",
			"keyTerms-D": "Key Terms",
			"keyTerms-S": "Key Terms",
			"paratextSync-D": "Paratext Sync",
			"paratextSync-T": "Paratext Sync",
			"peerReview": "Peer Review",
			"peerReview-D": "Peer Review",
			"peerReview-T": "Peer Review",
			"peerReview-S": "Peer Review",
			"record": "Record",
			"record-D": "Record",
			"record-S": "Record",
			"review": "Review",
