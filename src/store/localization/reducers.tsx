...
const initialState = {
	...
	"community": new LocalizedStrings({
		"en": {
			...
			"record": "Record",
			"releaseRights": "Upload or record a statement releasing the rights to publish material recorded by this speaker.",
			"rights": "Rights",
	...
	"findResource": new LocalizedStrings({
		"en": {
			"aiDesc": "Copy query contents and paste them into one of an AI chat tools:",
			"bibleBrain": "{0} Resource",
			"bibleProjectLang": "Bible Project Language",
	...
	"passageDetailArtifacts": new LocalizedStrings({
		"en": {
			...
			"findResourceDesc": "Each of these links can be used to find or create (using artificial intelligence -- AI) resources for internalizing the passage, section, chapter, or book.",
	...
	"planSheet": new LocalizedStrings({
		"en": {
			...
			"confirmPublishSection": "If you choose to publish, the {0} and the latest version of all passages and notes in this {0} will be marked as published. If you have previously published and now choose 'Not Published', the passages and notes be marked as not published.",
	...
	"vProject": new LocalizedStrings({
		"en": {
			...
			"errExtrasBookNonScripture": "Book Designation must not be a Scripture book code.",
