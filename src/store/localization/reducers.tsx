...
const initialState = {
	...
	"vProject": new LocalizedStrings({
		"en": {
			...
			"permissionEditSheet": "Allow to edit Audio Project Setup sheet content.  If left blank, all team members will be allowed to edit the sheet.  Admins are always allowed to edit.",
			"permissionPublish": "Allow to publish content.  If left blank, all team members will be allowed to publish.  Admins are always allowed to publish.",
			"preview": "Preview",
