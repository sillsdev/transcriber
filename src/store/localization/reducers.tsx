...
const initialState = {
	...
	"cards": new LocalizedStrings({
		"en": {
			...
			"recognizePrompt": "Choose the language to recognize. If the language is not available, choose a closely related language with a similar writing system.",
			"recognizeSpeech": "Recognize Speech",
			"recognizeSpeechSettings": "Recognize Speech Settings",
	...
	"planSheet": new LocalizedStrings({
		"en": {
			...
			"confirmPublishMovement": "If you choose to publish, the {0} and the latest version of all passages and notes in all {0} in this Movement will be marked as published. If you have previously published and now choose 'Not Published', the {0} and passages and notes will be marked as not published.",
			"confirmPublishMovementNoPropogate": "The publishing status of the {0} in the movement will not be changed. If you choose to publish, the Movement will be marked as published. If you have previously published and now choose 'Not Published', the movement will be marked as not published, but if any {0} are published, the Movement will still appear in {1}.",
			"confirmPublishSection": "If you choose to publish, the {0} and the latest version of all passages and notes in this {0} will be marked as published. If you have previously published and now choose 'Not Published', the passages and notes will be marked as not published.",
			"confirmPublishSectionNoPropogate": "If you choose to publish, the {0} will be marked as published but the publishing status of the passages and notes in this {0} will not be changed. If you have previously published and now choose 'Not Published', the {0} will be marked as not published.",
			...
			"pasting": "Pasting",
			"propogate": "Propogate to all {0} in the {1}.",
			"publish": "Publish {0} {1}",
			"published": "Publish",
	...
	"scriptureTableFilter": new LocalizedStrings({
		"en": {
			"apply": "Apply",
			"assignedToMe": "Only rows with discussions assigned to me",
			"clear": "Clear",
	...
	"voice": new LocalizedStrings({
		"en": {
			...
			"stHired": "Since I am being compendated by the team, my voice can be used by the team without additional compensation.",
			"stJoin": "and",
	...
	"wsAudioPlayer": new LocalizedStrings({
		"en": {
			...
			"recognizeProgress": "Recognize Speech in Progress",
			"recognizePrompt": "Choose the language to recognize. If the language is not available, choose a closely related language with a similar writing system.",
			"recognizeSpeech": "Recognize Speech {0}",
			"recognizeSpeechSettings": "Recognize Speech Settings",
			"record": "Record [{0}]",
			"reduceNoise": "Reduce Noise",
			"resume": "Resume",
