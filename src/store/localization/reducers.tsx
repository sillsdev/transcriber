...
const initialState = {
	...
	"access": new LocalizedStrings({
		"en": {
			...
			"noOnlineUsers1": "To allow offline use, while online mark your project as 'Available Offline' in your project settings.",
			"or": "or",
			"noOnlineUsers2": "Import a Project that your admin has exported.",
