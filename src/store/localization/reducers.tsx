...
const initialState = {
	...
	"access": new LocalizedStrings({
		"en": {
			...
			"onlineWorkDesc": "Transcription can be done online or offline.",
			"offlineWorkDesc": "All work is always done offline.",
			"back": "Back",
	...
	"welcome": new LocalizedStrings({
		"en": {
			...
			"setupFactor2Help": "Projects are Made Available Offline on the three dot More Menu on each Project Card.",
			"team": "Work in a team project",
			"teamTip": "A project has been set up online.  Transcribers and editors can work online, offline by downloading the project, or offline by importing it.",
