...
const initialState = {
  ...
  community: new LocalizedStrings({
    en: {
      ...
      record: 'Record',
      releaseRights:
        'Upload or record a statement releasing the rights to publish material recorded by this speaker.',
      rights: 'Rights',
  ...
  import: new LocalizedStrings({
    en: {
      ...
      unknownError:
        'If this error occured while importing offline changes, please close the app immediately and reopen.  If the error persists, contact support.  If you continue to use the app, you will lose offline changes.',
      invalidProject: 'Import File does not contain current audio project.',
  ...
  integration: new LocalizedStrings({
    en: {
      ...
      questionPermission:
        'Do you have permission to edit the Paratext project text?',
  ...
  mediaUpload: new LocalizedStrings({
    en: {
      ...
      intellectualPropertyTask:
        'Upload an intellectual property release for {0} in audio or visual format. Audio formats accepted are .mp3, .m4a, .wav or .ogg. Visual formats accepted are .pdf, .png, or .jpg.',
  ...
  permission: new LocalizedStrings({
    en: {
      ...
      consultantTip:
        "Not sure we need this permission either, because it is unclear what special things consultants do in this software.  Independant Consultant's comments will be visible to all team members.",
  ...
  planSheet: new LocalizedStrings({
    en: {
      ...
      confirmPublishMovement:
        "If you choose to publish, the {0} and the latest version of all passages and notes in all {0} in this Movement will be marked as published. If you have previously published and now choose 'Not Published', the {0} and passages and notes will be marked as not published.",
      confirmPublishSection:
        "If you choose to publish, the {0} and the latest version of all passages and notes in this {0} will be marked as published. If you have previously published and now choose 'Not Published', the passages and notes will be marked as not published.",
      ...
      paratextRequired:
        'You must be a Paratext user with access to FOBAI resources to use this feature.',
      ...
      published: 'Publish',
      refErr:
        'This audio project contains invalid references and will not sync to Paratext properly. (A valid reference would be 3:2-5 or similar.)',
  ...
  profile: new LocalizedStrings({
    en: {
      ...
      deleteExplained:
        'Deleting your user will block you from using the program and remove references to your work.',
  ...
  publishLevel: new LocalizedStrings({
    en: {
      ...
      bibleRequired:
        'You must have set up a Bible Id and Name in the Team Settings to publish to Akuo or Obthelps.',
  ...
  shared: new LocalizedStrings({
    en: {
      admin: 'Admin',
      bookNotInParatext:
        'Passage {0}.{1}: Paratext project does not contain book {2}.',
      ...
      expiredParatextToken:
        "Your paratext login has expired and can't be automatically renewed.  Please log out and login again.",
      expiredToken:
      ...
      referenceNotFound:
        'Reference does not exist in Paratext chapter, or reference is within a larger verse range.',
      role: 'Role',
      save: 'Save',
      saving: 'Saving...',
      select: 'Select',
  ...
  template: new LocalizedStrings({
    en: {
      ...
      renderExportTemplate:
        'The {SECT} template works for files exported from Render.',
  ...
  vProject: new LocalizedStrings({
    en: {
      ...
      howToPublic:
        'Contact Nathan Payne (nathan_payne@sil.org) for access to create shared content.',
      language: 'Language',
      layout: 'Layout',
      movement: 'Movement',
      movements: 'Movements',
