...
const initialState = {
	...
	"access": new LocalizedStrings({
		"en": {
			...
			"noOnlineUsers3": "To create an online project for working alone:",
			"noOnlineUsers4": "Create a personal project.",
	...
	"audacitySetup": new LocalizedStrings({
		"en": {
			...
			"versions": "NB: Audacity integration was last tested with version {0} of Audacity and Linux requires the snap package.",
		}
	}),
	...
	"newProject": new LocalizedStrings({
		"en": {
			...
			"other": "Other",
			"likeTemplate": "These options present different templates for getting started. Choices made here can be changed in the Edit Project Settings dialog box.",
	...
	"welcome": new LocalizedStrings({
		"en": {
			"alone": "Work Alone",
			"aloneFactor": "Projects cannot be changed to team projects later",
			"import": "Import Project",
			...
			"setupFactor2": "Supports projects that are offline available",
			"setupFactor2Help": "Select the Offline Available option on the project card menu.",
			"setupTeam": "Set up a team project",
			"setupTeamTip": "Set up the project, dividing work into passages that can be assigned to various transcribers and editors.  Transcribers and editors can work online or offline by downloading or importing the project.",
			"team": "Work in a team project",
			"teamFactor": "Project has been set up online",
			"teamTip": "A project has been set up online.  Transcribers and editors can work online, offline by selecting the Offline Available option on the project card menu, or offline by importing it.",
			"title": "Welcome",
		}
	}),
};
