...
var CommandFactory = /** @class */ (function () {
  ...
  CommandFactory.removePadding = function (
    input,
    output,
    duration,
    temporaryFile
...
var Normalizer = /** @class */ (function () {
  ...
  Normalizer.validate = function (_a) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      return _this.fileHasAudio(input).then(function (hasAudio) {
        if (hasAudio) {
          return resolve(
            __assign({ input: input, output: output, loudness: loudness }, rest)
          );
        } else {
  ...
  Normalizer.removePadding = function (_a, resolve, reject) {
    ...
    var command = CommandFactory.removePadding(
      input,
      output,
      originalDuration,
      temporaryFile
  ...
  return new Promise(function (resolve, reject) {
    ...
    return Normalizer.validate(input)
      ...
      ['catch'](function (error) {
        ...
        return reject(
          __assign(
            { normalized: false, error: error.message ? error.message : error },
            input
          )
        );
      });
